		...
		<div class="card">
			<div class="card-body">
				...
				<div class="input-group">
					<input type="text" v-model="item" @keyup.enter="addItem(item)" placeholder="Digite o item" class="form-control">
					<div class="input-group-append">
						<button class="btn btn-info" @click="addItem(item)"><span class="fa fa-plus"></span></button>
					</div>
				</div>
			</div>
		</div>
